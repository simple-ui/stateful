 ...
 *
 * @module @simple-ui/stateful
 * @license
 * @simple-ui/stateful 1.0.0 <https://simple-ui.io/>
 * Copyright 2017 Simple UI <https://simple-ui.io/>
 * Available under MIT license <https://simple-ui.io/license>
 */
...
Stateful.prototype = {
  ...
  rewind() {
    ...
    let states = this.__stateHistory__.pop();
   ...
   */
  current() {
    return (this.__state__.length <= 1)
      ? this.__state__[0]
      : this.__state__;
  },
